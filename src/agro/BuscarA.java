...
Conexion conn = new Conexion ();
    ...
    public BuscarA() {
        initComponents();
         ...
         cargaTabla();
          ...
          private void cargaTabla() {
           m.setRowCount(0);
        String sql = "SELECT id,  concat(Siglas, HBP) Ani, Nombre, RP, Pelaje FROM Animal";
        String columna = "RP";
        ...
        try {
            ...
            Logger.getLogger(BuscarA.class.getName()).log(Level.SEVERE, null, ex);
        }
 }
...
//    
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(BuscarA.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
