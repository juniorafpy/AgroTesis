 ...
 */
public class BuscarAlim extends javax.swing.JFrame {
        ...
        initComponents();
         ...
         cargaTabla();
          ...
          private void cargaTabla() {
           m.setRowCount(0);
        String sql = "SELECT id,  concat(Siglas, HBP) Ani, Nombre, RP, Pelaje, idRaza FROM Animal";
        String columna = "RP";
        ...
        try {
            ...
            while(conn.resultado.next()){
                m.addRow(new Object[] {conn.resultado.getInt("id"),
                    conn.resultado.getString("Ani") ,  conn.resultado.getString("Nombre"),
                    conn.resultado.getString("RP"),
                    conn.resultado.getString("Pelaje"), conn.resultado.getString("idRaza")});
            }
        } catch (SQLException ex) {
            Logger.getLogger(BuscarAlim.class.getName()).log(Level.SEVERE, null, ex);
        }
 }
...
//    
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(BuscarAlim.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new BuscarAlim().setVisible(true);
            }
        });
    }
